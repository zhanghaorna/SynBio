...
public class CommonUtil {
	...
	public static final String DB_NAME = "Synbio";
	...
	public static boolean isWiFiAvailable(Context context)
	{
	  ...
	  public static String convertDate(String date)
	  {
	    ...
	    if (date.contains("-"))
	    {
	      ...
	      return year.trim() + "/" + month.trim() + "/" + day.trim() + "/" + hour.trim() + "/" + minute.trim();
	    }
	    else
	    {
	    	String hour = date.split(",")[0].split(":")[0];
		    String minute = date.split(",")[0].split(":")[1];
		    String year = date.split(",")[1].split("/")[2];
